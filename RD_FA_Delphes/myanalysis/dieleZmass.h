...
#ifdef dieleZmass_cxx
dieleZmass::dieleZmass(TTree *tree) : fChain(0) 
{
...
dieleZmass::~dieleZmass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t dieleZmass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dieleZmass::LoadTree(Long64_t entry)
{
...
void dieleZmass::Init(TTree *tree)
{
...
void dieleZmass::Show(Long64_t entry)
{
...
Int_t dieleZmass::Cut(Long64_t entry)
{
