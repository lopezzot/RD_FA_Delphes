...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MuEfficiency(TTree *tree=0);
   virtual ~MuEfficiency();
...
#ifdef MuEfficiency_cxx
MuEfficiency::MuEfficiency(TTree *tree) : fChain(0) 
{
...
Int_t MuEfficiency::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuEfficiency::LoadTree(Long64_t entry)
{
...
void MuEfficiency::Init(TTree *tree)
{
...
void MuEfficiency::Show(Long64_t entry)
{
...
Int_t MuEfficiency::Cut(Long64_t entry)
{
